package com.taolibrary.widget.dialog.prompt;
...
import com.taolibrary.widget.dialog.prompt.sub.Builder;
import com.taolibrary.widget.dialog.prompt.sub.PromptButton;
import com.taolibrary.widget.dialog.prompt.sub.PromptView;
import com.taolibrary.interfaces.dialog.prompt.OnAdClickListener;
...
//                outAnim.setStartOffset(delayTime);
    ...
    public void showError(String msg, boolean withAnim) {
        showSomthing(R.mipmap.t_ic_prompt_error, PromptView.PROMPT_ERROR, msg, withAnim);
    }
    ...
    public void showInfo(String msg, boolean withAnim) {
        showSomthing(R.mipmap.t_ic_prompt_info, PromptView.PROMPT_INFO, msg, withAnim);
    }
    ...
    public void showWarn(String msg, boolean withAnim) {
        showSomthing(R.mipmap.t_ic_prompt_warn, PromptView.PROMPT_WARN, msg, withAnim);
    }
    ...
    public void showSuccess(String msg, boolean withAnim) {
        showSomthing(R.mipmap.t_ic_prompt_success, PromptView.PROMPT_SUCCESS, msg, withAnim);
    }
    ...
    private void showAlert(String text, boolean withAnim, PromptButton... button) {
        ...
        builder.text(text);
        builder.icon(R.mipmap.t_ic_prompt_alert_warn);
        closeInput();
        promptView.setBuilder(builder);
        checkLoadView(withAnim);
...
//        builder.
    ...
    public void showLoading(String msg, boolean withAnim) {
        ...
        if (promptView.getCurrentType() != PromptView.PROMPT_LOADING) {
            Builder builder = Builder.getDefaultBuilder();
            builder.icon(R.mipmap.t_ic_prompt_loading);
            builder.text(msg);
            promptView.setBuilder(builder);
            closeInput();
            checkLoadView(withAnim);
