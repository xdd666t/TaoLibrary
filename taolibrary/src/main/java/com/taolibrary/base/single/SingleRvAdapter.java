 ...
 */
public abstract class SingleRvAdapter<T> extends RecyclerView.Adapter<SingleRvAdapter.BaseViewHolder> {
    ...
    public SingleRvAdapter(int layoutId) {
        mList = new ArrayList<>();
        this.layoutId = layoutId;
    }


    public SingleRvAdapter(List<T> list, int layoutId) {
        if (list == null) {
            list = new ArrayList<>();
        }
        mList = list;
    ...
    @Override
    public void onBindViewHolder(SingleRvAdapter.BaseViewHolder holder, int position) {
    ...
    public interface OnLayoutListener {
        void onLayout(SingleRvAdapter.BaseViewHolder holder, int position);
    }
