...
import com.yt.matisse.engine.ImageEngine;
import com.yt.matisse.filter.Filter;
import com.yt.matisse.engine.impl.GlideEngine;
import com.yt.matisse.engine.impl.PicassoEngine;
import com.yt.matisse.internal.entity.CaptureStrategy;
import com.yt.matisse.internal.entity.SelectionSpec;
import com.yt.matisse.listener.OnCheckedListener;
import com.yt.matisse.listener.OnSelectedListener;
import com.yt.matisse.ui.CameraActivity;
import com.yt.matisse.ui.MatisseActivity;
...
public final class SelectionCreator {
    private final MatisseGo mMatisse;
     ...
     */
    SelectionCreator(MatisseGo matisse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMatisse = matisse;
    ...
    SelectionCreator(MatisseGo matisse) {
        mMatisse = matisse;
        mSelectionSpec = SelectionSpec.getCleanInstance();
    }
     ...
     * <p>
     * It's a redundant API with {@link MatisseGo#(Intent)},
