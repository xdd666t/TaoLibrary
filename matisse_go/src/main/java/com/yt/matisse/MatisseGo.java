 ...
 */
public final class MatisseGo {

    private final WeakReference<Activity> mContext;
    private final WeakReference<Fragment> mFragment;

    private MatisseGo(Activity activity) {
        this(activity, null);
    }

    private MatisseGo(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private MatisseGo(Activity activity, Fragment fragment) {
     ...
     */
    public static MatisseGo from(Activity activity) {
        return new MatisseGo(activity);
    }
     ...
     * @return Matisse instance.
     */
    public static MatisseGo from(Fragment fragment) {
        return new MatisseGo(fragment);
    }
